    ...
    <div class='row'>
        <div class='col-sm-12'>
            <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                ...
                <form action="/data/slideshow/edit/{{$data->id}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                        @csrf
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-md-5'>
                                Kosongkan file, jika gambar tidak di ganti
                            </div>
                        </div>
